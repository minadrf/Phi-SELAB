...
class SendPostModelForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['post_text'].widget = forms.Textarea(
            attrs={'placeholder': 'Your point of view ...', 'id': 'comment',
...
class EditProfileForm(forms.Form):
    ...
    prof_image = forms.ImageField(
        ...
        widget=forms.FileInput(attrs={'class': 'file-input btn btn-block btn-primary btn-file'}), required=False
    )

    def __init__(self, member, *args, **kwargs):
        super(EditProfileForm, self).__init__(*args, **kwargs)
        self.fields['first_name'].widget = forms.TextInput(
            attrs={'class': 'form-control', 'placeholder': member.user.first_name})
        self.fields['last_name'].widget = forms.TextInput(
            attrs={'class': 'form-control', 'placeholder': member.user.last_name})
        self.fields['displayed_name'].widget = forms.TextInput(
            attrs={'class': 'form-control', 'placeholder': member.displayed_name})
        ...
        self.fields['birthday'].widget = forms.DateInput(
            attrs={'class': 'form-control', 'type': 'date', 'placeholder': member.birthday})
